...
<body class="window_class" style="padding-top:10px;">
  ...
  <div class="col-md-9">    
    ...
    <a href="<?php echo PUERTO."://".HOST;?>/admin/generarExcel/<?php echo $_SESSION['filtrar_consultados']['M']; ?>/" class="col-md-1 offset-md-11 btn btn-success"><i class="fa fa-download"></i> Excel</a>
...
<input style="display:none" type="text" id="datosGrafico" value="" />
