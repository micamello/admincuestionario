...
class Modelo_Respuesta{
  ...
  public static function verResultados($edad='', $nacionalidad='', $provincia='', $genero='', $estadocivil='', $profesion='', $ocupacion='',
    ...
    $sql = "SELECT u.id_usuario, u.nombres, u.apellidos, u.correo, u.id_nacionalidad, u.id_provincia, u.genero, u.id_empresa,
    ...
    if ($metodo == 0){
      ...
      $rs = $GLOBALS['db2']->auto_array($sql,array(),true);        
    }
    return $rs;
  }

  public static function resultadoxUsuario($idusuario,$base=0){
    ...
    if (empty($base)){      
      ...
      $rs = $GLOBALS['db2']->auto_array($sql,array($idusuario),true);  
    }
